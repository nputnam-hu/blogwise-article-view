	  ...
	  _createClass$2(BlogPostTemplate, [{
	    ...
	    value: function render() {
	      ...
	      return React__default.createElement(
	        ...
	        React__default.createElement(
	          ...
	          !isPreview && React__default.createElement(
	            ...
	            React__default.createElement(
	              ...
	              React__default.createElement(FacebookIcon, { size: 32, round: true })
	            ),
	            React__default.createElement(
	              TwitterShareButton,
	              { url: pageUrl, title: title },
	              React__default.createElement(TwitterIcon, { size: 32, round: true })
	            ),
	            React__default.createElement(
	              EmailShareButton,
	              { url: pageUrl, subject: title },
	              React__default.createElement(EmailIcon, { size: 32, round: true })
	            ),
	            React__default.createElement(
	              LinkedinShareButton,
	              { url: pageUrl, title: title },
	              React__default.createElement(LinkedinIcon, { size: 32, round: true })
	            )
	          ),
	          React__default.createElement(
	            'div',
	        ...
	        !isPreview && React__default.createElement('hr', null),
