...
var Time$1 = function (_React$Component) {
  ...
  _createClass(Time, [{
    ...
    value: function render() {
      ...
      var formattedDate = React.createElement('div', null);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          tags.map(function (tag) {
            return isPreview ? React.createElement(
              'span',
              { key: tag },
              React.createElement(
                'li',
      ...
      posts.map(function (_ref2) {
        ...
        return React.createElement(
          ...
          React.createElement(
            Link,
            { to: slug },
            thumbnail ? React.createElement(Img, { alt: title, fixed: thumbnail.childImageSharp.fixed }) : React.createElement('div', { style: { height: 150, width: 200 } }),
            React.createElement(
              'div',
...
var BlogPostTemplate = function (_Component) {
  ...
  function BlogPostTemplate(props) {
    ...
    _this.state = { scrollHeight: 0, pageUrl: '' };
  ...
  _createClass$2(BlogPostTemplate, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          Img = _props.Img,
          isPreview = _props.isPreview,
          EmailIcon = _props.EmailIcon,
          FacebookIcon = _props.FacebookIcon,
          LinkedinIcon = _props.LinkedinIcon,
          TwitterIcon = _props.TwitterIcon,
          EmailShareButton = _props.EmailShareButton,
      ...
      return React.createElement(
        'section',
        {
          ...
          className: styles$3.BlogPost + ' ' + (isPreview ? styles$3.BlogPost__preview : '')
        },
        Progressbar,
        helmet || '',
        React.createElement(
        ...
        React.createElement(
          ...
          isPreview ? author && React.createElement(
            'span',
          ...
          React.createElement(
            ...
            React.createElement(Time$1, { size: 'large', date: publishDate })
          )
        ),
        ...
        coverPhoto && isPreview && React.createElement('img', {
          style: { maxWidth: '100%' },
          src: coverPhoto,
          alt: 'Cover Photo'
        }),
        ...
        tags && tags.length > 0 && React.createElement(
          ...
          React.createElement(TagList, { tags: tags, isPreview: isPreview, Link: Link })
        ),
        React.createElement(
          'div',
          ...
          !isPreview && React.createElement(
            'div',
            { className: styles$3.AuthorPage__sharebuttons },
            React.createElement(
              FacebookShareButton,
              { url: pageUrl, quote: title },
            ...
            React.createElement(
              EmailShareButton,
              { url: pageUrl, subject: title },
              React.createElement(EmailIcon, { size: 32, round: true })
            ),
            React.createElement(
              LinkedinShareButton,
              { url: pageUrl, title: title },
              React.createElement(LinkedinIcon, { size: 32, round: true })
            )
          ),
          React.createElement(
            'div',
            ...
            React.createElement(
              ...
              isPreview ? author && React.createElement('img', {
        ...
        !isPreview && React.createElement('hr', null),
        morePosts && morePosts.length > 0 && React.createElement(MorePosts, { posts: morePosts, Link: Link, Img: Img })
      );
    }
  }]);
...
export { PostView as Template1, InnerHTML as InnerHTMLonly, BlogPostTemplate as Template1Canonical };
